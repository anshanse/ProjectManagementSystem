...
public class DeveloperService {
    ...
    public void getSumSalaryDevsOnProject (int id){
        printMessage.printResult(repository.sumSalaryDevsOnProject(id));
    }

    public void getDevWithSkill (String skill){
        printMessage.printResult(repository.devWithSkill(skill));
    }

    public void getDevWithGrade (String grade){
        printMessage.printResult(repository.devWithGrade(grade));
    }
}
